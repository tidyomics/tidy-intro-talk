...
-   Annotated matrix data, see also in python `xarray`, `AnnData`

-   Metadata on organism, genome build, annotation release, etc.

-   Bioconductor S4: 2002: *ExpressionSet*; 2011: *SummarizedExperiment*

-   Many functions in Bioconductor are *endomorphic*: `x |> f -> x`
...
# New: Efficient operation on SE with `plyxp`
